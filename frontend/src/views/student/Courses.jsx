                        ...
                        <div className="col-lg-9 col-md-8 col-12">
                            ...
                            {fetching === true && <p className="mt-3 p-3">Loading...</p>}
                             ...
                             {fetching === false && (
                                    ...
                                    <form className="row gx-3">
                                        <div className="col-lg-12 col-md-12 col-12 mb-lg-0 mb-2">
                                            <input
                                                ...
                                                placeholder="Search Your Courses" onChange={handleSearch}
                                            />
                                        </div>
                                    </form>
                                </div>
                                ...
                                <button className='btn btn-primary btn-sm mt-3'>Start Course<i className='fas fa-arrow-right ms-2'></i></button>
